...
#  Default: ''
c.NotebookApp.browser = 'open -a /Applications/Min.app %s'
...
#  Choices: any of ['sha256', 'md5', 'sha512', 'blake2s', 'blake2b', 'sha224', 'sha3_224', 'sha3_256', 'sha3_512', 'sha384', 'sha1', 'sha3_384']
#  Default: 'sha256'
